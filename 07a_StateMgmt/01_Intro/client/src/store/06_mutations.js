...
export default new Vuex.Store({
    state: {
        ausbildung: [
            ...
            {sid: 100, mid: 291, title: '291-Oberflächen (UIs) mit Webtechnologien entwickeln', mark: '5',
            ...
            {sid: 101, mid: 291, title: '291-Oberflächen (UIs) mit Webtechnologien entwickeln', mark: '5',
                _cellVariants: {mark: 'warning'}
            }
        ]
